...
Note: `branches_from` was removed from this file — that relationship lives entirely in `cluster_branches.csv`.

---

### 3. `cluster_branches.csv`
...
Build `cluster_branches.csv` with all from→to connections and primary path flags.
